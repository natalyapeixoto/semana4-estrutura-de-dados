...
// 2- Crie um Array de 10 valores, apenas com Números Ímpares.
// depois imprima os valores na tela

// 3 - Dada a array const bandasEmo = ['fresno', 'linkin park', 'blink182', 'dance of days'];
// inverta a ordem dos items e log na tela : 'dance of days', 'blink182', 'linking park', 'fresno'

// 4 Dada a array const arr = ['sorvete', 'pirulito', 'bombom'];
// Adicione um novo item de sua escolha no final dessa array.

// 5- Dada a array const arr = ['sorvete', 'pirulito', 'bombom'];
// Adicione um novo item de sua escolha no começo dessa array.

//6 - Dada a array const array = [ 23, 45, 13, 71];
// Insira o número 11 no meio, chegando ao output = 23, 45, 11, 13, 71

//7-  Dada a array const array = [ 23, 45, 13, 17];
...
// 9- dada a array const unordered = [56, 89, 34, 12, 23, 55, 9];
// ordene a unordered array.
